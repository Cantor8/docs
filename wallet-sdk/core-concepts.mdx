---
title: "Core concepts"
description: "Understand Canton identifiers, wallet transports, instruments, and account data."
---
...
An **instrument** is a Canton asset type, such as a tokenized currency or security. A **holding** is a specific account's balance of that instrument.

Each account also includes its public key and validator:
