...
description: "Handle wallet connection, approval, data, and transaction errors."
---
...
<AccordionGroup>
  ...
  <Accordion title="POPUP_BLOCKED" icon="ban">
    The browser blocked the wallet popup. Call interactive methods such as `connect()`, `send()`, `createSwapOffer()`, `signMessage()`, and `signAndExecute()` from a user gesture such as a button click.
  </Accordion>
